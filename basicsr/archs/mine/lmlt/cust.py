...
class ConvFFN(nn.Module):
    def __init__(self, dim, growth_rate=2.0, split_rate=0.25):
        super().__init__()
        ...
        self.dwc = nn.Conv2d(dwc_dim, dwc_dim, 3, stride=1, padding=1, groups=dwc_dim)
...
if __name__== '__main__':
    ...
    # x, factor = torch.randn(1, 3, 640, 360), 2
    # x, factor = torch.randn(1, 3, 427, 240), 3
    x, factor = torch.randn(1, 3, 320, 180), 4
